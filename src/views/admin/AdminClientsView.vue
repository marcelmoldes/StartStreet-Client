                ...
                <div class="min-w-full py-2 align-middle sm:px-6 lg:px-8">
                  <table class="min-w-full divide-y divide-gray-300">
                    ...
                    <tbody class="divide-y divide-gray-200">
                      <tr v-for="client in pageOfOrders" :key="client">
                        <td
...
export default {
  ...
  computed: {
    pageOfOrders() {
      return this.clients.slice(this.startingAt - 1, this.endingAt);
    },
    startingAt() {
    ...
    endingAt() {
      ...
      if (endingAt > this.clients.length) {
        return this.clients.length;
      }
      return endingAt;
    },
    pages() {
      return Math.ceil(this.clients.length / this.recordsPerPage);
    },
    y() {
  ...
  methods: {
    async loadData() {
      let response = await axios.get("http://localhost:8081/clients", {
        headers: {
