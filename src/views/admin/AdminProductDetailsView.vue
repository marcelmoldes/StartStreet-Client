            ...
            <div>
              ...
              <div class="mt-2.5">
                <input
                  ...
                  type="text"
                  class="w-full rounded-md border-0 px-3.5 py-2 text-center text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                />
              </div>
            </div>
  ...
  methods: {
    async loadData() {
      let response = await axios.get(
        "http://localhost:8081/admin/item/" + this.$route.params.id,
        {
          headers: {
